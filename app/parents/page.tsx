...
export default function ParentsPage() {
    return (
        <>
            ...
            {/* 강사 이력 - 메인과 동일한 구성, 학부모용 페이지의 밝은 배경에 맞춘 라이트 톤 */}
            <CareerSection id="career" variant="light" />
                    ...
                    <div className={styles.grid}>
                        <Card title="고교 수학은 체계화된 시스템">
                            ...
                            <p className={styles.cardDesc}>
                                ...
                                고3까지 아이들이 흔들리지 않을 수 있는 수업을 제공합니다.
                            </p>
                        </Card>
                        <Card title="학부모에게 진실된 상담">
                            <h3 className={styles.cardTitle}>학부모에게 진실된 상담</h3>
                            <p className={styles.cardDesc}>
                                아이가 조금 부족해서 그렇다. 공부를 열심히 해야한다. 등 보편적인 상담은 진행하지 않습니다.
